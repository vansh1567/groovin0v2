        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-4">
            <button className="flex items-center gap-2 px-4 py-2 text-blue-600 
              ...
              <span className="text-sm font-medium">Create Deals</span>
            </button>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {currentItems.map((deal) => (
                <tr key={deal.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{deal.propertyName}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{deal.startDate}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{deal.endDate}</td>
